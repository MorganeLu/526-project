...
# # with L1
# l1_models, l1_scalers, l1_test_preds = models.train_logistic_l1_models(subsets, X_test)
...
# # with L2
# l2_models, l2_scalers, l2_test_preds = models.train_logistic_l2_models(subsets, X_test)
...
# feature_names = subsets[0][0].columns
# utils.print_param_lr(l2_models[0], feature_names)
